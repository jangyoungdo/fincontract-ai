...
| Backend | 조항 분리 | implemented | article + nested-numbering source-span regression verified | PDF 복잡 표 구조 복원 제외 |
| Backend | 위험도 판정 | prototype | 14-rule, PII false-positive, article-context regression verified | 합성 데이터, 전문가 검토 미완료 |
